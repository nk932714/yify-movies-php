<?php         
            ...
            if (isset($_GET['magnet_uri']) && !empty($_GET['magnet_uri'])) { $magnet_uri = $_GET["magnet_uri"]; $magnet_uri_placeolder = $magnet_uri; }
    ...
    <script>
        ...
        window.webtor.push({
            ...
            on: function(e) {
             ...
             //poster: 'https://via.placeholder.com/150/0000FF/808080?Text=Digital.com',
             subtitles: [
                 {
                     //srclang: 'en',
                     //label: 'test',
