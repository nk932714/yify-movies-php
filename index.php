              ...
              <div class="clear"></div>
                  ...
                  <?php  
                          ...
                          for ($y = 0; $y <= $countresults; $y++) {
                                       ...
                                       $imns = $y+1; echo '<ln><a id="lefti" href="#'.$image_url[$y].'"> Click to Load Image '.$imns.'</a></ln>'; echo '&emsp;&emsp;';  echo '<ln><a id="lefti" href="#SCREENSHOTS'.$imdb_code[$y].'"> Click to Load screenshots '.$imns.'</a></ln>';echo'&emsp;&emsp;<b>Rips - </b><ln><a href="#RIPs'.$orignal_link_url[$y].'">check RIPs</a></ln>'; echo '<div class="inline" id="#RIPs'.$orignal_link_url[$y].'"></div>';                                       echo '<div id="#'.$image_url[$y].'"></div>';   echo '<div id="#SCREENSHOTS'.$imdb_code[$y].'"></div></div>';
                                                                   }
                  ?>
