              ...
              <div class="clear"></div>
                  ...
                  <?php   if (!empty($title1)) {
                          ...
                          for ($y = 0; $y <= $countresults; $y++) {
                                       ...
                                       echo '<br><b> Magnet Link = </b><a href="'.$magnet_link1[$y].'">'.$magnet_link1[$y].'</a>'; echo '&emsp;&emsp;<ln><a id="lefti" href = "webtor_player.php?magnet_uri='.$magnet_link1[$y].'&images_uri='.$image_url[$x].'">Stream online(beta)</a></ln>';
