              ...
              <div class="clear"></div>
                  ...
                  <?php  
                          ...
                          for ($y = 0; $y <= $countresults; $y++) {
                                       ...
                                       echo '<br><b> Size - </b>'.$size1[$y];   if(empty($yt_trailer_code1[$y])){ echo '&emsp;&emsp;<b> Youtube Trailer - </b><a class="youtube" href="https://www.youtube.com/embed/?listType=search&list='.$title1[$y].'"> View Trailer(popup)</a>'; } else{ echo '&emsp;&emsp;<b> Youtube Trailer - </b><a class="youtube" href="https://www.youtube.com/watch?v='.$yt_trailer_code1[$y].'"> View Trailer(popup)</a>'; } echo '&emsp;&emsp; if(empty($yt_trailer_code1[$y])){ echo '&emsp;&emsp;<b> Youtube Trailer - </b><a  href="https://www.youtube.com/embed/?listType=search&list='.$title1[$y].'">View Trailer(normal)</a>'; } else{ echo '&emsp;&emsp;<b> Youtube Trailer - </b><a href="https://www.youtube.com/watch?v='.$yt_trailer_code1[$y].'">View Trailer(normal)</a>'; } echo '&emsp;&emsp; <b> Language - </b>'/*.$language1[$y]*/;echo '<ln><a href="#LANGUAGE'.$orignal_link_url[$y].'">check language</a></ln>'; echo '<div class="inline" id="#LANGUAGE'.$orignal_link_url[$y].'"></div>';
