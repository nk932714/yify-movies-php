 ...
 <body>
       <div id="rounded">
          <img src="img/top_bg.gif" alt="top" /><div id="main" class="container">
              <h1>Yify Torrents</h1>
              <h2>Simpler is better</h2><br> <div id="noJS">Please enable JavaScript. Otherwise wite won't work properly.</div>
