              ...
              <div class="clear"></div>
                  ...
                  <?php  
                          ...
                          for ($y = 0; $y <= $countresults; $y++) {
                                       ...
                                       echo '<br><b> Size - </b>'.$size1[$y];   if(empty($yt_trailer_code1[$y])){ echo '&emsp;&emsp;<b> Youtube Trailer - </b><a class="youtube" href="https://www.youtube.com/embed/?listType=search&list='.$title1[$y].'">Pc view</a>'; } else{ echo '&emsp;&emsp;<b> Youtube Trailer - </b><a class="youtube" href="https://www.youtube.com/watch?v='.$yt_trailer_code1[$y].'">Pc view</a>'; } echo '&emsp;&emsp;'; if(empty($yt_trailer_code1[$y])){ echo '<a href="https://www.youtube.com/embed/?listType=search&list='.$title1[$y].'">Normal View</a>'; } else{ echo '<a href="https://www.youtube.com/watch?v='.$yt_trailer_code1[$y].'">Normal View</a>'; } echo '&emsp;&emsp; <b> Language - </b>'/*.$language1[$y]*/;echo '<ln><a href="#LANGUAGE'.$orignal_link_url[$y].'">check language</a></ln>'; echo '<div class="inline" id="#LANGUAGE'.$orignal_link_url[$y].'"></div>';                                       echo '<br><button class="collapsiblea">Synopsis(Click to view)</button><div class="content"><p>'.$synopsis1[$y].'</p></div>';    echo '<button class="collapsiblea">More Magnet Links</button><div class="content"><p>'.$complete_torrent_info1[$y].'</p></div>';
